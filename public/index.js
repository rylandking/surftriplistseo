...
let surfSpotRef = db.collection('surf-spot').doc('airport-rights');

////////////////////
// THIS:
// 1. Gets the document defined in surfSpotRef
// 2. Prints it to seo-description.html to edit description copy
////////////////////
...
//     <p class="mb-2">Feel free to email us at surftriplist @ gmail to help improve this information.</p>
//   `;
...
////////////////////
// THIS:
// 1. Gets all documents in the surf-spot collection
// 2. Sets seoDescription to each document in the surf-spot collection
////////////////////
// db.collection('surf-spot')
// 	.get()
...
// ssDescriptions.innerHTML = `${ssDescription}`;
// console.log(doc.id);
//// Update documents in the surf-spot collection
// 	db.collection('surf-spot').doc(doc.id).set(
// 		{
// 			seoDescription: ssDescription,
// 		},
// 		{ merge: true }
// 	);
// });
